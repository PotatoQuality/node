...
const kCode = v8.createPrivateSymbol('code');
const kInfo = v8.createPrivateSymbol('info');
...
E('ERR_BUFFER_TOO_LARGE', bufferTooLarge);
...
var kMaxLength;
function bufferTooLarge() {
  if (kMaxLength === undefined) {
    kMaxLength = global.process.binding('buffer').kMaxLength;
  }
  return `Cannot create a Buffer larger than 0x${kMaxLength.toString(16)} bytes`
}
...
defineProperty(binding, 'errors', {value: exports});
defineProperty(global, 'errors', {value: exports, configurable: true});
