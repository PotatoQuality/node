...
const {
  ...
  ObjectPrototype,
  Reflect,
  StringPrototype: { charCodeAt, includes: stringIncludes, replace },
} = primordials;
...
const kTraceCount = charCodeAt('C', 0);
const kTraceBegin = charCodeAt('b', 0);
const kTraceEnd = charCodeAt('e', 0);
const kTraceInstant = charCodeAt('n', 0);
